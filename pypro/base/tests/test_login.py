...
from pypro.django_assertions import assert_equal, assert_contains, assert_not_contains
...
def test_login_redirect(resp_post):
    assert_equal(resp_post.status_code, 302)
    assert_equal(resp_post.url, reverse('modulos:indice'))
